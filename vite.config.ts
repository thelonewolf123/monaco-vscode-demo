...
export default defineConfig({
    ...
    optimizeDeps: {
        ...
        include: [
            ...
            '@codingame/monaco-vscode-coffeescript-default-extension',
            ...
            '@codingame/monaco-vscode-julia-default-extension',
            ...
            '@codingame/monaco-vscode-vb-default-extension',
            ...
            '@codingame/monaco-vscode-npm-default-extension',
            '@codingame/monaco-vscode-css-default-extension',
            ...
            '@codingame/monaco-vscode-configuration-editing-default-extension',
